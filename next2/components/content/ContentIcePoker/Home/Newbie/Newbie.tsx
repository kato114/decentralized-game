...
import styles from './Newbie.module.scss';
import { formatPrice } from '@/common/utils';

export interface NewbieProps {
  content?: any;
}

const IceDashboardNewbie = (): ReactElement => {
    ...
    <section className={cn('row', styles.main_wrapper)}>
      <div className={cn('col-xl-8', styles.overview_container)}>
        ...
        <div className={styles.blue_container}>
          <div className={styles.blue_text}>
            ...
            <p className={styles.blue_lower}>
              Get started playing ICE Poker with just a <br /> few simple steps.
            </p>
            <Button
              className={styles.blue_button}
              onClick={() => {
                router.push('/ice/start');
              }}
            >
              Get Started
            </Button>
          </div>
          <img className={styles.blue_img} src="https://res.cloudinary.com/dnzambf4m/image/upload/v1645784052/image_43_cwnlty.png" />
        </div>
        ...
        <div className={styles.second_container}>
          ...
          <div className={cn(styles.box, styles.find_delegator)}>
            <h1 className={styles.title}>Find a Delegator</h1>
            <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1645797677/Rectangle_2x_ug6tao.png" alt="discord" />
            <p>Start playing for free by receiving delegation from a wearable owner.</p>
            <Button
              className={styles.grey_button}
              onClick={() => {
...
export default IceDashboardNewbie;
