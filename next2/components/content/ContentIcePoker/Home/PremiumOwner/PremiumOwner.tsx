...
const IceDashboardPremium = (): ReactElement => {
    ...
    (async (): Promise<void> => {
      if (state.userLoggedIn) {
        ...
        try {
          ...
          const response = Object.assign([], state.delegationBreakdown);
  ...
  }, [state.userLoggedIn, state.delegationBreakdown]);
    ...
    <section className={cn('row', styles.main_wrapper)}>
      <div className={cn('col-xl-8', styles.overview_container)}>
        ...
        <div className={styles.guild_league}>
          ...
          <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1646018772/PNG_1_rthpdb.png" alt="guild" />
          <p>Guild League is coming soon! You will need to hold at least 5,000 xDG and 5 wearables to qualify for the lowest tier league.</p>
...
export default IceDashboardPremium;
