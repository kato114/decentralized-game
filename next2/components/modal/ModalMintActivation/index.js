...
const ModalMintActivation = props => {
    ...
    <>
      {!pending ? (
        <Modal
          ...
          open={open}
          close
          trigger={<Button className={styles.open_button}>Activate</Button>}
        >
          ...
          <div className={styles.title}>First Mint, Then Activate</div>
          <div className={styles.desc}>In order to start playing ICE Poker with this wearable, you will need to first mint it, then activate it after.</div>
          <div className="d-flex">
            <div className={styles.logo_left}>
              <img src="https://res.cloudinary.com/dnzambf4m/image/upload/c_scale,w_210,q_auto:good/v1625014714/ETH_kzfhxr.png" alt="logo" />
              ...
              <div className={styles.round_desc}>
                {state.tokenAmounts.WETH_COST_AMOUNT} ETH + {state.stakingBalances?.BALANCE_USER_GOVERNANCE} DG Staked
              </div>
            </div>
...
export default ModalMintActivation;
