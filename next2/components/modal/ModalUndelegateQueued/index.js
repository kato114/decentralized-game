...
const ModalUndelegateQueued = props => {
  ...
  return (
    <Modal
      ...
      open={open}
      close
      trigger={<Button className={styles.open_button}>{props.buttonName}</Button>}
    >
      ...
      >
        <div className={styles.wear_box_body}>
          ...
          <div className={styles.description}>
            After 12pm UTC({props.remainingTime} hours), you will not longer be delegating to{' '}
            {props.delegateAddress && <a>{props.delegateAddress.substr(0, 4) + '...' + props.delegateAddress.substr(-4)}</a>}. Any previous profits can be claimed from your{' '}
