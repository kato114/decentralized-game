...
import styles from './ModalDepositPolygon.module.scss';

const ModalDepositPolygon = props => {
    ...
    return (
        <Modal
            className={styles.deposit_polygon_modal}
            onClose={() => {
                setOpen(false);
                props.close();
            }}
        ...
        >
            ...
            <div className={styles.success_container}>
                <div className={styles.title}>Deposit With Polygon Bridge</div>

                <div className={styles.description}>
                    We use the <a href="https://polygon.technology/" target="_blank">Polygon network</a> for our products. For the best deposit and withdraw experience, we recommend using Polygon Bridge.
                </div>

                <div className={styles.img}>
                    <img src="https://res.cloudinary.com/dnzambf4m/image/upload/v1638539378/Polygon_lo2ldl.png" alt="Polygon" />
                </div>
...
export default ModalDepositPolygon;
